...
def layout():
    ...
    dbc.Row(
        [
            ...
            dbc.Col(
                [
                dcc.Markdown("## Gráfico pie", className="text-secondary my-sm-5 text-center"),
                pie_plot,
                dcc.Markdown("## Gráfico de barras", className="text-secondary my-sm-5 text-center"),
                bar_plot,
                dcc.Markdown("## Gráfico de linea", className="text-secondary my-sm-5 text-center"),
                line_plot,
